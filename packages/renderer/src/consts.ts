...
export const URL_TÉLÉCHARGEMENTS = `https://github.com/${DÉPÔT_GITHUB}/releases`;
export const IPA_TÉLÉCHARGEMENTS = `https://api.github.com/repos/${DÉPÔT_GITHUB}/releases`;
